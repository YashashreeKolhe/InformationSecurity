...
def matrixInverse(matrix):
	if matrixDeterminant(matrix) == 0:
		return null
	transposeMatrix = matrixTranspose(matrix)
	resMatrix = [[0 for i in range(0, 3)] for i in range(0, 3)]
	
	resMatrix[0][0] = matrix[1][1] * matrix[2][2] - matrix[1][2] * matrix[2][1]
	resMatrix[0][1] = -1 * (matrix[1][0] * matrix[2][2] - matrix[1][2] * matrix[2][0])
	resMatrix[0][2] = matrix[1][0] * matrix[2][1] - matrix[1][1] * matrix[2][0]
	resMatrix[1][0] = -1 * (matrix[0][1] * matrix[2][2] - matrix[0][2] * matrix[2][1])
	resMatrix[1][1] = matrix[0][0] * matrix[2][2] - matrix[0][2] * matrix[2][0]
	resMatrix[1][2] = -1 * (matrix[0][0] * matrix[2][1] - matrix[0][1] * matrix[2][0])
	resMatrix[2][0] = matrix[0][1] * matrix[1][2] - matrix[0][2] * matrix[1][1]
	resMatrix[2][1] = -1 * (matrix[0][0] * matrix[1][2] - matrix[0][2] * matrix[1][0])
	resMatrix[2][2] = matrix[0][0] * matrix[1][1] - matrix[0][1] * matrix[1][0]
...
def main():
	...
	for line in fr:
		...
		matrixMult = matrixMultiplication(keyMatrix, matrix)
		if flag == 0:
